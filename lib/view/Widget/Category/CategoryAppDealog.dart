...
class Categoryappdealog extends StatefulWidget {
  final Categorydealogmode mode;
  final Joiningcategoriesappcontroller controller;
  final int? id;

  const Categoryappdealog({
    super.key,
    required this.mode,
  ...
  @override
  State<Categoryappdealog> createState() => _CategoryappdealogState();
}

class _CategoryappdealogState extends State<Categoryappdealog> {
...
class CategoryIndexappDialog extends StatelessWidget {
  final Joiningcategoriesappcontroller controller;
  final CategoryModel categorymodel;

  const CategoryIndexappDialog({
    super.key,
    required this.controller,
