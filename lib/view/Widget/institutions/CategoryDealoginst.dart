...
class Categorydealoginstitutions extends StatefulWidget {
  final Categorydealoginstmode mode;
  final Joiningcategoriescontrollerinstitutions controller;
  final int? id;

  const Categorydealoginstitutions({
    super.key,
    required this.mode,
  ...
  @override
  State<Categorydealoginstitutions> createState() =>
      _CategorydealoginstitutionsState();
}

class _CategorydealoginstitutionsState
    extends State<Categorydealoginstitutions> {
...
class CategoryIndexDialoginst extends StatelessWidget {
  final Joiningcategoriescontrollerinstitutions controller;
  final CategoryModel categorymodel;

  const CategoryIndexDialoginst({
    super.key,
    required this.controller,
