import 'package:chafi_dashboard/controller/DifferentController.dart';
...
class Custemdifferentedealog extends StatelessWidget {
  final DifferentcontrollerImp controller;
  final DifferentsModel law;

  const Custemdifferentedealog({
    super.key,
