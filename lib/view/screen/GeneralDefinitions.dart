...
class Generaldefinitions extends StatefulWidget {
  const Generaldefinitions({super.key});

  @override
  State<Generaldefinitions> createState() => _GeneraldefinitionsState();
}

class _GeneraldefinitionsState extends State<Generaldefinitions> {
  @override
  Widget build(BuildContext context) {
    Get.create(() => Generaldefinitionscontroller());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<Generaldefinitionscontroller>(
        builder: (controller) {
          return Container(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InstitutionsCard(
                                ...
                                onEditindex: () {
                                  ...
                                  showDialog(
                                    context: context,
                                    builder: (_) => CustemGeneralDefinitionsdealog(
