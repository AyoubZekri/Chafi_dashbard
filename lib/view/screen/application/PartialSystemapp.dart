...
import 'package:chafi_dashboard/view/screen/application/Editapp.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../../../controller/application/AddAppController.dart';
...
class Partialsystemapp extends StatefulWidget {
  const Partialsystemapp({super.key});

  @override
  State<Partialsystemapp> createState() => _PartialsystemappState();
}

class _PartialsystemappState extends State<Partialsystemapp> {
  @override
  Widget build(BuildContext context) {
    Get.create(() => PartialsystemappcontrollerImp());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<PartialsystemappcontrollerImp>(
        builder: (controller) {
          return Container(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InstitutionsCard(
                          ...
                          onEditindex: () {
                            ...
                            showDialog(
                              context: context,
                              builder: (_) => CustemPartialappdealog(
