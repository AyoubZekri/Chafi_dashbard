...
class Adddifferent extends StatefulWidget {
  ...
  @override
  State<Adddifferent> createState() => _AdddifferentState();
}

class _AdddifferentState extends State<Adddifferent> {
  @override
  Widget build(BuildContext context) {
    final controller = Get.find<AdddifferentcontrollerImp>();

    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<AdddifferentcontrollerImp>(
        builder: (_) {
                      ...
                      children: [
                        Expanded(
                          child: CustemtextfromfildInfoUser(
                            ...
                            valid: (val) {
                              return validateInput(val!, 2, 100, "title");
                            },
                          ),
                        ),
                        SizedBox(width: 24),
