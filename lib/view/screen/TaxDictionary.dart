...
import '../Widget/TaxDictionary/TaxDictionaryDealog.dart';
import '../Widget/TextFild/SearchFild.dart';

class TaxDictionary extends StatefulWidget {
  const TaxDictionary({super.key});

  @override
  State<TaxDictionary> createState() => _TaxDictionaryState();
}

class _TaxDictionaryState extends State<TaxDictionary> {
  @override
  Widget build(BuildContext context) {
    Get.create(() => TaxDictionaryControllerImp());

    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<TaxDictionaryControllerImp>(
        builder: (controller) {
          return Container(
                ...
                Container(
                  ...
                  child: ActionButton(
                    ...
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) => TaxDictionaryDealog(
                          mode: TaxDictionaryDealogMode.add,
                              ...
                              return InstitutionsCard(
                                ...
                                onEdit: () {
                                  ...
                                  showDialog(
                                    context: context,
                                    builder: (context) => TaxDictionaryDealog(
                                      mode: TaxDictionaryDealogMode.edit,
                                      controller: controller,
                                      id: item.id,
                                    ),
                                  );
                                ...
                                onEditindex: () {
                                  ...
                                  showDialog(
                                    context: context,
                                    builder: (_) => TaxDictionaryIndexDialog(
                                      controller: controller,
