...
class Simplifiedsystem extends StatefulWidget {
  const Simplifiedsystem({super.key});

  @override
  State<Simplifiedsystem> createState() => _SimplifiedsystemState();
}

class _SimplifiedsystemState extends State<Simplifiedsystem> {
  @override
  Widget build(BuildContext context) {
    Get.create(() => SimplifiedsystemcontrollerImp());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<SimplifiedsystemcontrollerImp>(
        builder: (controller) {
          return Container(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InstitutionsCard(
                          ...
                          onEditindex: () {
                            ...
                            showDialog(
                              context: context,
                              builder: (_) => CustemSimplTaxdealog(
