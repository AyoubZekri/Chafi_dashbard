...
class Addtaxcollection extends StatefulWidget {
  ...
  @override
  State<Addtaxcollection> createState() => _AddtaxcollectionState();
}

class _AddtaxcollectionState extends State<Addtaxcollection> {
  @override
  Widget build(BuildContext context) {
    Get.find<AddtaxcollectioncontrollerImp>();
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<AddtaxcollectioncontrollerImp>(
        builder: (controller) {
