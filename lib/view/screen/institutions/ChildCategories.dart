...
import '../../Widget/institutions/ChildCategoryDealoginst.dart';
...
class _ChildcategoriesState extends State<Childcategories> {
  ...
  Widget build(BuildContext context) {
    Get.create(() => Childcategoriescontrollerinst());

    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<Childcategoriescontrollerinst>(
        builder: (controller) {
          return Container(
                ...
                Container(
                  ...
                  child: ActionButton(
                    ...
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) => Childcategorydealoginst(
                          mode: .add,
                          ...
                          SizedBox(
                            ...
                            child: CustemDropDownField(
                              items: controller.shwocategory
                                  ...
                                  .toList(),
                              value: controller.showselectedCategory,
                              onChanged: (value) {
                                setState(() {
                                  controller.showselectedCategory = value!;
                                  controller.viewdata();
                                });
                              },
                            ),
