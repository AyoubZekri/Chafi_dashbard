...
import '../../../controller/Institutions/JoiningCategoriesControllerinst.dart';
...
import '../../Widget/institutions/CategoryDealoginst.dart';

class Joiningcategoriesinstitutions extends StatefulWidget {
  const Joiningcategoriesinstitutions({super.key});

  @override
  State<Joiningcategoriesinstitutions> createState() =>
      _JoiningcategoriesinstitutionsState();
}

class _JoiningcategoriesinstitutionsState
    extends State<Joiningcategoriesinstitutions> {
  final ScrollController horizontalController = ScrollController();

  @override
  Widget build(BuildContext context) {
    Get.create(() => Joiningcategoriescontrollerinstitutions());

    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 243, 243, 243),
      body: GetBuilder<Joiningcategoriescontrollerinstitutions>(
        builder: (controller) {
          return Container(
                ...
                Container(
                  ...
                  child: ActionButton(
                    ...
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) => Categorydealoginstitutions(
                          mode: Categorydealoginstmode.add,
                                            ...
                                            InkWell(
                                              onTap: () {
                                                ...
                                                showDialog(
                                                  context: context,
                                                  builder: (context) =>
                                                      Categorydealoginstitutions(
                                                        mode:
                                                            Categorydealoginstmode
                                                                .edit,
                                                        controller: controller,
                                                        id: item.id,
                                                      ),
