...
abstract class TaxDictionaryController extends GetxController {}

class TaxDictionaryControllerImp extends TaxDictionaryController {
  ...
  void editindex(int id) async {
    if (formState.currentState!.validate()) {
      ...
      statusrequest = Statusrequest.loadeng;
      update();
      Map<String, dynamic> reqData = {"id": id, "index": index.text};
      var response = await differentdata.editdata(reqData);
      print("=====================================$response");
      statusrequest = handlingData(response);
  ...
  @override
  void onInit() {
    print("TaxDictionaryController Init");
    viewdata();
    super.onInit();
  }
}
